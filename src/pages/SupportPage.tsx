    ...
    <section className="section-pad bg-canvas">
      <div className="container-shell">
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Link to="/mis-contactos" className="focus-ring rounded-lg border border-border bg-muted px-4 py-3 text-center text-sm font-bold text-content">Ver mis contactos</Link>
          {whatsappUrl ? <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="focus-ring rounded-lg border border-border bg-muted px-4 py-3 text-center text-sm font-bold text-content">Soporte por WhatsApp</a> : null}
        </div>
