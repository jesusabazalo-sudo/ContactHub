...
export default function ThemeToggle({ className = '' }: ThemeToggleProps) {
  ...
  return (
    <button
      ...
      className={`focus-ring relative inline-flex h-10 w-10 items-center justify-center rounded-full border border-border bg-surface text-content-secondary transition hover:border-brand/40 hover:text-content ${className}`}
    >
      <Sun
