import { BookOpen, Bot, BriefcaseBusiness, Dumbbell, GraduationCap, PackageSearch, Palette, Wrench } from 'lucide-react';
...
const useCases = [
  ...
  { icon: Dumbbell,          title: 'Quiero mejorar mi salud',        text: 'Fitness, nutrición, bienestar y proveedores de salud al alcance.' },
];
    ...
    <section className="section-pad bg-canvas">
      <div className="container-shell">
        ...
        <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {useCases.map((item) => (
            <article key={item.title} className="professional-card p-5">
