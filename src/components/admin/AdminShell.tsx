import { FolderKanban, Gift, Home, KeyRound, ListChecks, MessageCircle, UploadCloud, UserRoundCog, UsersRound } from 'lucide-react';
    ...
    <section className="section-pad bg-ink-950">
      <div className="container-shell">
        ...
        <div className="mb-8 overflow-x-auto rounded-2xl border border-line bg-ink-950/50 p-2">
          <div className="flex min-w-max items-center gap-2 whitespace-nowrap">
            <span className="px-3 text-xs font-bold uppercase tracking-wide text-gray-500">Gestión</span>
            {managementLinks.map((link) => (
              <AdminLink key={link.to} link={link} unreadSupport={unreadSupport} />
            ))}
          </div>
        </div>
